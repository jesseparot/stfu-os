...
- Un chemin vers un dossier projet (`projects/{project-name}/`)
- Des chemins vers des fichiers specifiques
- Le nom d'un projet/client (le skill cherche dans `projects/`)
...
→ Le skill cherche dans projects/arkea-banque-conversationnelle/
